                    ...
                    <ul class="selector">
                        <li id="image1">
                            <label>
                                ...
                                <img class="img-responsive" src="views/images/Elements/Feu.png" alt="Feu">
                            </label>
                        </li>
                        <li id="image2">
                            <label>
                                <input type="radio" name="element" value="eau"/>
                                <img class="img-responsive" src="views/images/Elements/Eau.png" alt="Eau">
                            </label>
                        </li>
                        <li id="image3">
                            <label>
                                <input type="radio" name="element" value="air"/>
                                <img class="img-responsive" src="views/images/Elements/Air.png" alt="Air">
                            </label>
                        </li>
                        <li id="image4">
                            <label>
                                <input type="radio" name="element" value="foudre"/>
                                <img class="img-responsive" src="views/images/Elements/Foudre.png" alt="Foudre">
                            </label>
                        </li>
                        <li id="image5">
                            <label>
                                <input type="radio" name="element" value="bois"/>
                                <img class="img-responsive" src="views/images/Elements/Bois.png" alt="Bois">
                            </label>
                        </li>
                    </ul>
                </div>

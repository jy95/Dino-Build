...
<head>
    ...
    <style type="text/css">
        ...
        thead td
        {
            ...
            background-image: url(<?php echo "../../views/images/competences/fd_table" . $element . ".png"?>);
    ...
    <script type="text/javascript" src="<?php echo PATH_ABSOLUTE . "/js/jquery-2.1.4.min.js"?>"></script>
</head>
<body>
